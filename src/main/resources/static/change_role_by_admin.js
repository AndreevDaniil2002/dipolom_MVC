        ...
        .then((res) => {
            ...
            fetch('/api/v1/roles')
                ...
                .then(response => {
                    ...
                    <button class="ml-3 d-block  md:w-1/2 text-center rounded-md py-3 px-5 md:mx-auto bg-green text-white text-xl md:text-xl" type="submit">Изменить роль</button>
                    `
